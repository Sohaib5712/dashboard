/* This is a React component called `UpdateUser` that allows a user with admin privileges to update the
information of a specific user. It imports several hooks and components from the React and React
Router libraries, as well as a custom hook called `useAuthContext` from a local file. */
