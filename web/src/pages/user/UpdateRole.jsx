/* This is a React component called `UpdateRole` that allows a user with admin privileges to update a
user role. It imports several hooks and components from the React and React Router libraries,
including `useState`, `useEffect`, `useParams`, `useNavigate`, and `useAuthContext`. */
