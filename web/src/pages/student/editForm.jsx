/* The above code is a React component that renders a form to edit student data. It fetches the student
data from an API endpoint using the student ID obtained from the URL parameters. It also fetches a
list of courses from another API endpoint to display as checkboxes for the user to select. The form
allows the user to update the student's name, phone number, email, gender, and selected courses.
Upon submission, the updated data is sent to the API endpoint to update the student record. The
component also renders a sidebar and header based on the user's role obtained from the
