/* This is a React component called `Course` that displays a table of courses. It imports various React
hooks and components such as `useEffect`, `useState`, `Link`, `useNavigate`, `SideBar`, `Header`,
`useAuthContext`, `RiQuillPenFill`, and `RiDeleteBinLine`. */
                ...
                <div className="student-heading">
                    ...
                    <Link to="/addcourse">
                        <div className="add-btn">
                            <span className="add-icon">+</span> Add Course
                        </div>
                    </Link>
                </div>
                <table>
                    ...
                    <tbody>
                        {students &&
                            students.map((course, index) => (
                                <tr key={course._id}>
                                    <td>{index + 1}</td>
                                    <td><img src={ course.courseImageUrl } alt="" style={{width: "100px", height:"100px"}}/></td>
                                    <td>{course.course_name}</td>
                                    <td className='col-2'>{course.desc}</td>
                                    <td>{course.fee}</td>
